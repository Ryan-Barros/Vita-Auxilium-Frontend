  ...
  return (
    <div className="bg-background dark:bg-[#191c1b] text-on-background dark:text-[#e1e3e0] min-h-screen flex items-center justify-center p-6 relative overflow-hidden transition-colors duration-300">
      ...
      <main className="w-full max-w-[1200px] grid grid-cols-1 lg:grid-cols-2 bg-surface-container-lowest dark:bg-[#2e312f] shadow-2xl rounded-[32px] overflow-hidden relative z-10 transition-colors duration-300">
        <section className="hidden lg:flex flex-col justify-between p-16 bg-primary dark:bg-[#003738] text-on-primary relative overflow-hidden transition-colors duration-300">
          ...
          <div className="relative z-20">
            ...
            <p className="text-lg opacity-90 max-w-md font-light leading-relaxed">
              Uma plataforma pensada para proporcionar segurança, organização e
              tranquilidade para quem cuida e para quem é cuidado.
            </p>
          </div>
        ...
        <section className="p-8 md:p-16 flex flex-col justify-center bg-surface-container-lowest dark:bg-[#2e312f] transition-colors duration-300">
          <div className="max-w-md mx-auto w-full">
            <header className="mb-12">
              ...
              <p className="text-secondary dark:text-[#b4cbcb] text-lg transition-colors duration-300">
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full h-16 pl-14 pr-4 bg-surface-container-highest dark:bg-[#3e4949] dark:text-[#e1e3e0] border-none rounded-xl text-lg focus:ring-2 focus:ring-primary dark:focus:ring-[#8ed2d4] transition-all placeholder:text-outline/60 dark:placeholder:text-[#8ea0a0]"
                    id="email"
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full h-16 pl-14 pr-14 bg-surface-container-highest dark:bg-[#3e4949] dark:text-[#e1e3e0] border-none rounded-xl text-lg focus:ring-2 focus:ring-primary dark:focus:ring-[#8ed2d4] transition-all placeholder:text-outline/60 dark:placeholder:text-[#8ea0a0]"
                    id="password"
                    placeholder="••••••••"
            ...
            <div className="mt-12 pt-8 border-t border-surface-container dark:border-[#3e4949] flex flex-col items-center gap-4 transition-colors duration-300">
              <p className="text-secondary dark:text-[#b4cbcb] text-lg transition-colors duration-300">
      ...
      <div className="fixed top-8 right-8 hidden md:flex items-center gap-4 bg-white/20 dark:bg-black/20 backdrop-blur-md p-2 rounded-full border border-white/30 dark:border-white/10 transition-colors duration-300">
        ...
        <button
          ...
          className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${
            isDark
              ? "bg-[#3e4949] text-[#8ed2d4] shadow-sm"
